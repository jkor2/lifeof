...
export default function ChartsPage() {
  ...
  // =====================================================
  // 🕒 Sleep Duration (fixed single axis)
  // =====================================================
  ...
  const sleepDurationOptions = {
    ...
    scales: {
      ...
      y1: { display: false }, // 👈 hides right axis
    },
  };
...
// =====================================================
// 📈 Linear Regression for HRV vs Recovery
// =====================================================
...
if (scatterData.length > 1) {
  ...
  // Pick min/max HRV for endpoints
...
const scatterConfig = {
  ...
  const handleRangeChange = (_: any, val: RangeType) => {
    if (val && val !== range) {
      setFading(true);
      setTimeout(() => { setRange(val); setFading(false); }, 150);
    }
  };
    ...
    <Container maxWidth="xl" sx={{ py: 6 }}>
      ...
      <Fade in={!fading}>
        <Paper sx={{ p: 4, mb: 6, background: "#181818", borderRadius: 4 }}>
          ...
          <Stack direction="row" flexWrap="wrap" spacing={1}>
            {data.recovery.insights.map((i, idx) => (
      ...
      <Fade in={!fading}>
        <Paper sx={{ p: 4, mb: 6, background: "#181818", borderRadius: 4 }}>
          ...
          <Divider sx={{ my: 3, opacity: 0.1 }} />
          <Stack direction="row" flexWrap="wrap" spacing={1}>
            {data.workouts.insights.map((i, idx) => (
